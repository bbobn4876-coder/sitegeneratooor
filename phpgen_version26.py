...
class PHPWebsiteGenerator:
    def __init__(self):
        ...
        self.api_key = "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"
...
<body>
    ...
    def generate_website(self, user_prompt, site_name, num_images=24, output_dir="generated_website", data_dir="data", site_type="multipage"):
        ...
        print("=" * 60)
        print(f"PHPGEN v26 - {'LANDING' if site_type == 'landing' else 'MULTIPAGE SITE'} GENERATOR")
        print("=" * 60)
